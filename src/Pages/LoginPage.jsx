...
function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <NavLink
        to="/"
        className="absolute top-4 left-4 md:top-10 md:left-48 text-red-600 text-3xl md:text-5xl font-bold"
      >
        BASFLIX
      </NavLink>
      <div className="relative z-10 w-full max-w-md bg-black bg-opacity-75 p-6 md:p-8 rounded">
        ...
        <form onSubmit={handleSignIn} className="px-2 md:px-5">
          <div className="mb-4">
            <input
              type="text"
              ...
              className="w-full p-2 md:p-3 bg-gray-700 rounded text-white"
            />
          </div>
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full p-2 md:p-3 bg-gray-700 rounded text-white pr-10"
              />
              <button
                type="button"
        ...
        <div
          className={`mt-4 text-xs text-gray-400 ${learn ? "h-fit" : "h-9"} overflow-hidden`}
        >
          <p>
